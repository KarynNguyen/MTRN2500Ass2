...
namespace GamePad {
  ...
  class XBoxController {
    ...
    private:
	  ...
	  DWORD ControllerId;			     //Private DWORD id variable
	  unsigned int deadzone;			 //Private deadzone variable
	  XINPUT_STATE State;				 //State struct
	  XINPUT_VIBRATION Vibration;	     //Vibartion struct 
  };
};
