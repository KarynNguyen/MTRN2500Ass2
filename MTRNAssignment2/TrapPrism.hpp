...
public:
	...
	TrapPrism(double a_length, double b_length, double height, double depth, double a_offset, float red, float green, float blue, double x, double y, double , double rotation);			//constructor with rotation
